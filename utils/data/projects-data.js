...
export const projectsData = [
    {
        ...
        tools: ['React', 'JavaScript', 'Node.js', 'Express', 'Stacks', 'Hiro', 'Groq Cloud'],
    ...
    },
    {
        ...
        shortDescription: 'Developed high-performance Golang middleware solutions with asynchronous processing and data validation. Implemented optimized order processing systems with Celery integration.',        tools: ['Go', 'Gin', "PostgreSQL", "Celery", "Google Cloud Services"],
        role: 'Backend Developer',
        code: '',
        demo: '',
        image: travel,
    },
    {
        ...
        shortDescription: 'Built a Django-based collaborative platform for technical professionals to share projects and expertise, featuring robust authentication and PostgreSQL database management.',        tools: ['Python', 'Django', 'PostgreSQL'],
        code: '',
    ...
    },
    {
        ...
        shortDescription: 'Designed an iOS fitness application with integrated healthcare communication capabilities, enabling real-time patient-provider interactions.',        tools: ['Python', 'Fast API', 'AWS', 'Docker', 'Redis', 'SendGrid', 'PostgreSQL'],
        code: '',
        demo: '',
        image: ayla,
        role: 'Backend Developer',
